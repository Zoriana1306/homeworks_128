...
function productList() {
  ...
  CART.forEach(function (prod, index) {
    var badge = prod.isBue ? '<span class="badge rounded-pill text-bg-success">Yes</span>' : '<span class="badge rounded-pill text-bg-danger">No</span>';
